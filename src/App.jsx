      ...
      <Section title="Generator-innstillinger">
        <Card>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 8, marginTop: 12 }}>
            ...
            <SettingHint title="Oddsgrenser">Min og max styrer totaloddsen for hele parlayen, ikke enkeltodds per leg.</SettingHint>
          </div>
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginTop: 12 }}>
      ...
      <Section title="Genererte parlays" right={<button onClick={() => setNonce((value) => value + 1)} style={buttonStyle}>Generate New Parlay</button>}>
        {!upcomingMatches.length ? (
          ...
          <EmptyState
            ...
            text="Ingen spill matcher valgte innstillinger. Prøv å senke minimum odds, redusere antall legs eller velge flere markeder."
          />
        )}
      </Section>
    </div>

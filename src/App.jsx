  ...
  return (
    <label style={{ display: "grid", gap: 5, minWidth: 0 }}>
      ...
      <input
        ...
        step={step}
        style={{ ...selectStyle, minWidth: 0, height: 46 }}
      />
...
const SelectField = ({ label, help, children, ...props }) => (
  <label style={{ display: "grid", gap: 5, minWidth: 0 }}>
    {label && <span style={{ color: C.text, fontSize: 12, fontWeight: 800 }}>{label}</span>}
    <select {...props} style={{ ...selectStyle, minWidth: 0, height: 46, ...(props.style || {}) }}>
      {children}
    </select>
    {help && <span style={{ color: C.muted, fontSize: 11, lineHeight: 1.35 }}>{help}</span>}
  </label>
        ...
        <Card>
          ...
          <div style={{
            ...
            {[
              ...
              <button key={key} onClick={() => update(key, !settings[key])} style={{
                ...buttonStyle,
                width: "100%",
                minHeight: 46,
